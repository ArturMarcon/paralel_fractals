...
int main(int argc, char **argv)
{
    ...
    if (rank == 0) {
        ...
        printf("programa=mpi_arvore tamanho=%d delta=%d processos=%d entrada=%d tempo=%.6f ordenado=%d tempo_min=%.6f tempo_max=%.6f tempo_medio=%.6f desbalanceamento=%.6f segmentos=%d\n",
